...
exports.leetcodeQuestionsFetch = void 0;
...
exports.leetcodeQuestionsFetch = (0, https_1.onRequest)(async (request, response) => {
...
async function getLeetCodeQuestions() {
    ...
    const response = await axios_1.default.get(leetCodeApiUrl);
